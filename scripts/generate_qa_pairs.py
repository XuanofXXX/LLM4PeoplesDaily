...
2. 答案要简洁准确，不超过20个字
3. 避免生成过于简单或过于复杂的问题
4. 问题要有一定的知识价值，适合用作问答测试
5. 答案应直接回答问题，不需要额外解释
6. 问题应涵盖文章的关键信息，如时间、地点、人物、事件、数据等。问题提及的各类时间应该完整表述，如“2023年10月1日”而不是“10月1日”，“中国特别研讨会”而不是“研讨会”。
7. 问题应避免使用模糊或开放式的提问方式，如“你怎么看待这篇文章？”或“这篇文章讲了什么？”等。
8. 问题和答案之间用": "分隔，答案应直接回答问题，不需要额外解释
